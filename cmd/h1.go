...
func init() {
	...
	h1Cmd.Flags().StringP("categories", "c", "all", "Scope categories, comma separated (Available: all, allinfra, url, cidr, mobile, android, apple, other, hardware, code, executable)")
